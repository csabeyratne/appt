trigger Service on Service__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    //    ServiceTrigger process = new ServiceTrigger(Trigger.new, Trigger.old, ServiceUtils.triggerAction.beforeInsert);
    //}
    //if(Trigger.isInsert && Trigger.isAfter){
    //    ServiceTrigger process = new ServiceTrigger(Trigger.new, Trigger.old, ServiceUtils.triggerAction.afterInsert);
    //}
    //if(Trigger.isUpdate && Trigger.isBefore){
    //    ServiceTrigger process = new ServiceTrigger(Trigger.new, Trigger.old, ServiceUtils.triggerAction.beforeUpdate);
    //}
    //if(Trigger.isUpdate && Trigger.isAfter){
    //    ServiceTrigger process = new ServiceTrigger(Trigger.new, Trigger.old, ServiceUtils.triggerAction.afterUpdate);
    //}
    //if(Trigger.isDelete && Trigger.isBefore){
    //    ServiceTrigger process = new ServiceTrigger(Trigger.old, null, ServiceUtils.triggerAction.beforeDelete);
    //}
    //if(Trigger.isDelete && Trigger.isAfter){
    //    ServiceTrigger process = new ServiceTrigger(Trigger.old, null, ServiceUtils.triggerAction.afterDelete);
    //}
