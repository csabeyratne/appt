trigger Holiday on Holiday__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    //    HolidayTrigger process = new HolidayTrigger(Trigger.new, Trigger.old, HolidayUtils.triggerAction.beforeInsert);
    //}
    //if(Trigger.isInsert && Trigger.isAfter){
    //    HolidayTrigger process = new HolidayTrigger(Trigger.new, Trigger.old, HolidayUtils.triggerAction.afterInsert);
    //}
    //if(Trigger.isUpdate && Trigger.isBefore){
    //    HolidayTrigger process = new HolidayTrigger(Trigger.new, Trigger.old, HolidayUtils.triggerAction.beforeUpdate);
    //}
    //if(Trigger.isUpdate && Trigger.isAfter){
    //    HolidayTrigger process = new HolidayTrigger(Trigger.new, Trigger.old, HolidayUtils.triggerAction.afterUpdate);
    //}
    //if(Trigger.isDelete && Trigger.isBefore){
    //    HolidayTrigger process = new HolidayTrigger(Trigger.old, null, HolidayUtils.triggerAction.beforeDelete);
    //}
    //if(Trigger.isDelete && Trigger.isAfter){
    //    HolidayTrigger process = new HolidayTrigger(Trigger.old, null, HolidayUtils.triggerAction.afterDelete);
    //}
