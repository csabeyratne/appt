trigger Staff on Staff__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    //    StaffTrigger process = new StaffTrigger(Trigger.new, Trigger.old, StaffUtils.triggerAction.beforeInsert);
    //}
    //if(Trigger.isInsert && Trigger.isAfter){
    //    StaffTrigger process = new StaffTrigger(Trigger.new, Trigger.old, StaffUtils.triggerAction.afterInsert);
    //}
    //if(Trigger.isUpdate && Trigger.isBefore){
    //    StaffTrigger process = new StaffTrigger(Trigger.new, Trigger.old, StaffUtils.triggerAction.beforeUpdate);
    //}
    //if(Trigger.isUpdate && Trigger.isAfter){
    //    StaffTrigger process = new StaffTrigger(Trigger.new, Trigger.old, StaffUtils.triggerAction.afterUpdate);
    //}
    //if(Trigger.isDelete && Trigger.isBefore){
    //    StaffTrigger process = new StaffTrigger(Trigger.old, null, StaffUtils.triggerAction.beforeDelete);
    //}
    //if(Trigger.isDelete && Trigger.isAfter){
    //    StaffTrigger process = new StaffTrigger(Trigger.old, null, StaffUtils.triggerAction.afterDelete);
    //}
